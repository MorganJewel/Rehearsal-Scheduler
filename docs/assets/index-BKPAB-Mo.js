(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))o(l);new MutationObserver(l=>{for(const a of l)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&o(i)}).observe(document,{childList:!0,subtree:!0});function n(l){const a={};return l.integrity&&(a.integrity=l.integrity),l.referrerPolicy&&(a.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?a.credentials="include":l.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(l){if(l.ep)return;l.ep=!0;const a=n(l);fetch(l.href,a)}})();const Y=new Map;let D=null;function C(e,t){Y.set(e,t)}function ne(e){D=e}function g(e){window.location.hash="#"+e}function oe(e,t){const n=e==="/"?[]:e.split("/").filter(Boolean),o=t==="/"?[]:t.split("/").filter(Boolean);if(n.length!==o.length)return null;const l={};for(let a=0;a<n.length;a++)if(n[a].startsWith(":"))l[n[a].slice(1)]=decodeURIComponent(o[a]);else if(n[a]!==o[a])return null;return l}function U(){const t=(window.location.hash||"#/").slice(1)||"/";for(const[n,o]of Y){const l=oe(n,t);if(l!==null){o(l);return}}D&&D()}function ae(){window.addEventListener("hashchange",U),U()}function H(){return crypto.randomUUID()}let $=[{id:"demo-prod-1",name:"Hamlet",playwright:"William Shakespeare",created_at:new Date().toISOString()}],v=[{id:"demo-sched-1",production_id:"demo-prod-1",name:"Act I Run-Through",date:"2026-06-15",created_at:new Date().toISOString()}],y=[{id:"demo-block-1",schedule_id:"demo-sched-1",scene_name:"Act I, Scene 1 — The Battlements",actors:"Hamlet, Horatio, Marcellus, Ghost",block_type:"blocking",duration_minutes:40,notes:`Work Ghost entrance from SR. Hamlet crosses to DSL on "I'll follow it."`,order_index:0},{id:"demo-block-2",schedule_id:"demo-sched-1",scene_name:"Act I, Scene 2 — The Court",actors:"Hamlet, Claudius, Gertrude, Polonius",block_type:"table work",duration_minutes:30,notes:`Discuss Hamlet's internal conflict. Emphasis on the "too too solid flesh" speech.`,order_index:1},{id:"demo-block-3",schedule_id:"demo-sched-1",scene_name:"Act I, Scene 3 — Polonius's House",actors:"Laertes, Ophelia, Polonius",block_type:"run-through",duration_minutes:25,notes:"Focus on Ophelia's reaction to advice. Speed run first, then notes.",order_index:2}];function le(){return[...$].sort((e,t)=>t.created_at.localeCompare(e.created_at))}function N(e){return $.find(t=>t.id===e)??null}function ie({name:e,playwright:t}){const n={id:H(),name:e,playwright:t||null,created_at:new Date().toISOString()};return $.push(n),n}function G(e,{name:t,playwright:n}){const o=$.find(l=>l.id===e);return o?(o.name=t,o.playwright=n||null,o):null}function K(e){v.filter(n=>n.production_id===e).map(n=>n.id).forEach(n=>O(n)),$=$.filter(n=>n.id!==e)}function se(e){return v.filter(t=>t.production_id===e).sort((t,n)=>t.created_at.localeCompare(n.created_at))}function J(e){return v.find(t=>t.id===e)??null}function de({name:e,date:t,production_id:n}){const o={id:H(),name:e,date:t||null,production_id:n,created_at:new Date().toISOString()};return v.push(o),o}function q(e,{name:t,date:n}){const o=v.find(l=>l.id===e);return o?(o.name=t,o.date=n||null,o):null}function O(e){y=y.filter(t=>t.schedule_id!==e),v=v.filter(t=>t.id!==e)}function re(e){return y.filter(t=>t.schedule_id===e).sort((t,n)=>t.order_index-n.order_index)}function ce({schedule_id:e,scene_name:t,actors:n,block_type:o,duration_minutes:l,notes:a,order_index:i}){const s={id:H(),schedule_id:e,scene_name:t||null,actors:n||null,block_type:o||null,duration_minutes:l||null,notes:a||null,order_index:i??0};return y.push(s),s}function ue(e,t){const n=y.find(o=>o.id===e);return n?(Object.assign(n,{scene_name:t.scene_name||null,actors:t.actors||null,block_type:t.block_type||null,duration_minutes:t.duration_minutes||null,notes:t.notes||null,order_index:t.order_index??n.order_index}),n):null}function me(e){y=y.filter(t=>t.id!==e)}const E=[{title:"Welcome to Rehearsal Scheduler",text:"This quick tour walks you through every feature — takes about 2 minutes. Hit Next to begin, or Skip to jump straight in.",target:null,page:null},{title:"Your Dashboard",text:"The Dashboard lists all your productions — plays, musicals, readings, anything you're directing. We've pre-loaded a demo production so you can explore right away.",target:"#productions-list",page:"/"},{title:"Create a Production",text:'Click "+ New Production" to start a show. Give it a title and an optional playwright credit. Productions are the top level of everything.',target:"#new-production-btn",page:"/"},{title:"Production Page",text:"Clicking a production card opens its detail page. The title and playwright sit at the top, and all rehearsal schedules for that show are listed below.",target:".page-title",page:"/production/demo-prod-1"},{title:"Schedules",text:'A schedule is one rehearsal session — usually one per day. Click a schedule card to open it, or use "+ New Schedule" to add one. Each schedule belongs to exactly one production.',target:"#schedules-list",page:"/production/demo-prod-1"},{title:"Schedule View",text:"Opening a schedule shows all its blocks in order. The total duration in minutes is summed up automatically next to the Blocks heading.",target:"#blocks-list",page:"/schedule/demo-sched-1"},{title:"Rehearsal Blocks",text:"Each card is one block: a scene, a run-through, table work, a tech call — whatever you need. Blocks show scene name, actors, type badge, duration, and your staging notes.",target:".block-card",page:"/schedule/demo-sched-1"},{title:"Adding & Editing Blocks",text:'Click "+ Add Block" to create a new one. Hit Edit on any block to change it. Each block has: scene name, actors, block type, duration in minutes, order index, and notes.',target:"#add-block-btn",page:"/schedule/demo-sched-1"},{title:"Block Types",text:"Five types, each colour-coded: Blocking (blue), Run-through (green), Table Work (gold), Tech (purple), Other (grey). Use them to visually scan a schedule at a glance.",target:".type-badge",page:"/schedule/demo-sched-1"},{title:"AI Schedule Names",text:"The Apertus AI panel reads your blocks and suggests 3 creative schedule names tailored to your scenes and actors. Click any suggestion to instantly rename the schedule.",target:".ai-panel",page:"/schedule/demo-sched-1"},{title:"You're All Set!",text:"That covers everything. Go create your own productions, build schedules, fill in blocks, and try the AI tool. Everything resets on refresh — so experiment freely.",target:null,page:null}];let u=-1;function V(){u=0,P()}async function P(){if(Z(),u<0||u>=E.length){A();return}const e=E[u];e.page&&(window.location.hash.slice(1)||"/")!==e.page&&(g(e.page),await W(220));const t=e.target?document.querySelector(e.target):null;t?(t.scrollIntoView({behavior:"instant",block:"center"}),await W(60),pe(t),ge(e,t)):he(e)}function pe(e){const n=e.getBoundingClientRect(),o=n.left-10,l=n.top-10,a=n.width+10*2,i=n.height+10*2,s=document.createElement("div");s.id="tour-overlay",s.style.cssText="position:fixed;inset:0;z-index:9000;pointer-events:none",s.innerHTML=`
  ...
  `}function _(){var e;(e=document.getElementById("tour-btn"))==null||e.addEventListener("click",V)}function m({title:e,bodyHTML:t,onSubmit:n,submitLabel:o="Save",showFooter:l=!0}){var i,s;r();const a=document.createElement("div");a.id="modal-overlay",a.className="modal-overlay",a.innerHTML=`
  ...
  `,document.body.appendChild(a),a.addEventListener("click",d=>{d.target===a&&r()}),document.getElementById("modal-close-btn").addEventListener("click",r),(i=document.getElementById("modal-cancel-btn"))==null||i.addEventListener("click",r),n&&((s=document.getElementById("modal-submit-btn"))==null||s.addEventListener("click",async()=>{const d=document.getElementById("modal-submit-btn");d.disabled=!0,d.textContent="Saving…";try{await n()}finally{d&&(d.disabled=!1,d.textContent=o)}}))}function r(){var e;(e=document.getElementById("modal-overlay"))==null||e.remove()}function be(){const e=document.getElementById("app");e.innerHTML=`
    ${I("dashboard")}
    <div class="page">
  ...
  `,_(),document.getElementById("new-production-btn").addEventListener("click",fe),T()}function T(){const e=document.getElementById("productions-list");if(!e)return;const t=le();if(!t.length){e.innerHTML=`
  ...
  `}function fe(){m({title:"New Production",bodyHTML:ee(),submitLabel:"Create",onSubmit:()=>{const e=document.getElementById("prod-name").value.trim();if(!e){document.getElementById("prod-error").textContent="Name is required.";return}ie({name:e,playwright:document.getElementById("prod-playwright").value.trim()}),r(),T()}})}function ve(e,t,n){m({title:"Edit Production",bodyHTML:ee(t,n),submitLabel:"Save",onSubmit:()=>{const o=document.getElementById("prod-name").value.trim();if(!o){document.getElementById("prod-error").textContent="Name is required.";return}G(e,{name:o,playwright:document.getElementById("prod-playwright").value.trim()}),r(),T()}})}function ye(e,t){var n;m({title:"Delete Production",bodyHTML:`
    ...
    `,_();return}L(e)}function L(e){const t=N(e);if(!t){g("/");return}const n=se(e),o=document.getElementById("app");o.innerHTML=`
    ${I()}
    <div class="page">
  ...
  `,_(),document.getElementById("edit-prod-btn").addEventListener("click",()=>$e(e,t,()=>L(e))),document.getElementById("delete-prod-btn").addEventListener("click",()=>Se(e,t.name)),document.getElementById("new-sched-btn").addEventListener("click",()=>xe(e,()=>L(e))),we(e,()=>L(e))}function Ee(e){return e.length?e.map(t=>`
    <div class="card card-clickable" data-id="${t.id}">
      <div class="card-header">
        <div>
          <div class="card-title">${w(t.name)}</div>
          ${t.date?`<div class="card-subtitle">${_e(t.date)}</div>`:""}
        </div>
        <div class="card-actions">
  ...
  `).join(""):`
    ...
    `}function we(e,t){document.querySelectorAll(".card-clickable").forEach(n=>{n.addEventListener("click",o=>{o.target.closest(".btn")||g("/schedule/"+n.dataset.id)})}),document.querySelectorAll(".sched-edit").forEach(n=>{n.addEventListener("click",o=>{o.stopPropagation(),Be(n.dataset.id,n.dataset.name,n.dataset.date,t)})}),document.querySelectorAll(".sched-del").forEach(n=>{n.addEventListener("click",o=>{o.stopPropagation(),Ie(n.dataset.id,n.dataset.name,t)})})}function $e(e,t,n){m({title:"Edit Production",bodyHTML:`
      <div class="form-group">
  ...
  `}function xe(e,t){m({title:"New Schedule",bodyHTML:te(),submitLabel:"Create",onSubmit:()=>{const n=document.getElementById("sched-name").value.trim();if(!n){document.getElementById("sched-error").textContent="Name required.";return}de({name:n,date:document.getElementById("sched-date").value||null,production_id:e}),r(),t()}})}function Be(e,t,n,o){m({title:"Edit Schedule",bodyHTML:te(t,n),submitLabel:"Save",onSubmit:()=>{const l=document.getElementById("sched-name").value.trim();if(!l){document.getElementById("sched-error").textContent="Name required.";return}q(e,{name:l,date:document.getElementById("sched-date").value||null}),r(),o()}})}function Ie(e,t,n){var o;m({title:"Delete Schedule",bodyHTML:`<p>Delete <strong>${w(t)}</strong>? All blocks will be removed.</p>`,submitLabel:"Delete",onSubmit:()=>{O(e),r(),n()}}),(o=document.getElementById("modal-submit-btn"))==null||o.classList.replace("btn-primary","btn-danger")}function _e(e){if(!e)return"";const[t,n,o]=e.split("-");return new Date(+t,+n-1,+o).toLocaleDateString("en-US",{weekday:"long",year:"numeric",month:"long",day:"numeric"})}function w(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function f(e){return String(e??"").replace(/"/g,"&quot;")}const Le=[50,60,5,45,23,2,62,34,54,21,11,24,46,27,52,29,46,56,61,49,29,63,47,61,53,51,54,54,56,34,41,53,14,52,23,23,23],Te=Le.map(e=>String.fromCharCode(e^90)).join(""),De=["blocking","run-through","table work","tech","other"];function Pe(e){const t=J(e),n=document.getElementById("app");if(!t){n.innerHTML=`
      ${I()}
      <div class="page">
        <p class="error-msg">Schedule not found.</p>
        <a href="#/" class="btn btn-ghost" style="margin-top:1rem">← Dashboard</a>
      </div>
    `,_();return}k(e)}function k(e){const t=J(e);if(!t){g("/");return}const n=N(t.production_id),o=re(e),l=o.reduce((i,s)=>i+(s.duration_minutes||0),0),a=document.getElementById("app");a.innerHTML=`
    ${I()}
    <div class="page">
      <div class="breadcrumb">
        <a href="#/">Dashboard</a> /
      ...
      <div class="page-header">
        <div class="page-header-left">
          ...
          ${t.date?`<p class="page-subtitle">${Fe(t.date)}</p>`:""}
        </div>
        <div style="display:flex;gap:0.5rem">
  ...
  `,_(),document.getElementById("edit-sched-btn").addEventListener("click",()=>Ne(e,t,()=>k(e))),document.getElementById("delete-sched-btn").addEventListener("click",()=>qe(e,t.name,n==null?void 0:n.id)),document.getElementById("add-block-btn").addEventListener("click",()=>z(null,e,o.length,()=>k(e))),document.getElementById("ai-btn").addEventListener("click",()=>Oe(e,t,n,o)),document.querySelectorAll(".block-edit").forEach(i=>{i.addEventListener("click",()=>{const s=o.find(d=>d.id===i.dataset.id);s&&z(s,e,s.order_index,()=>k(e))})}),document.querySelectorAll(".block-del").forEach(i=>{i.addEventListener("click",()=>He(i.dataset.id,i.dataset.name,()=>k(e)))})}function Ae(e){return e.length?e.map((t,n)=>`
    <div class="block-card">
      <div class="block-top">
        <div>
          ...
          ${t.block_type?`<span class="type-badge ${Re(t.block_type)}" style="margin-left:0.6rem">${h(t.block_type)}</span>`:""}
        </div>
  ...
  `}function Ce(e){return{schedule_id:e,scene_name:document.getElementById("b-scene").value.trim()||null,actors:document.getElementById("b-actors").value.trim()||null,block_type:document.getElementById("b-type").value||null,duration_minutes:parseInt(document.getElementById("b-duration").value)||null,order_index:parseInt(document.getElementById("b-order").value)||0,notes:document.getElementById("b-notes").value.trim()||null}}function z(e,t,n,o){const l=!!e;m({title:l?"Edit Block":"Add Block",bodyHTML:Me(e??{order_index:n}),submitLabel:l?"Save":"Add Block",onSubmit:()=>{const a=Ce(t);l?ue(e.id,a):ce(a),r(),o()}})}function He(e,t,n){var o;m({title:"Delete Block",bodyHTML:`<p>Delete block <strong>${h(t)}</strong>?</p>`,submitLabel:"Delete",onSubmit:()=>{me(e),r(),n()}}),(o=document.getElementById("modal-submit-btn"))==null||o.classList.replace("btn-primary","btn-danger")}function Ne(e,t,n){m({title:"Edit Schedule",bodyHTML:`
      <div class="form-group">
        <label class="form-label">Name *</label>
        <input class="form-input" id="sched-name" type="text"
...
Reply with exactly 3 schedule name suggestions, one per line, no numbering, no punctuation, no explanations. Just 3 names. [/INST]`;try{const p=await fetch("https://api-inference.huggingface.co/models/mistralai/Mistral-7B-Instruct-v0.2",{method:"POST",headers:{Authorization:`Bearer ${l}`,"Content-Type":"application/json"},body:JSON.stringify({inputs:b,parameters:{max_new_tokens:100,temperature:.8,return_full_text:!1}})});if(!p.ok){const c=await p.text();a.textContent=`API error ${p.status}: ${c.slice(0,100)}`,s.disabled=!1;return}const x=await p.json(),F=Array.isArray(x)?(R=x[0])==null?void 0:R.generated_text:x==null?void 0:x.generated_text;if(!F){a.textContent="No response from model.",s.disabled=!1;return}const j=F.split(`
`).map(c=>c.replace(/^[\d.\-*•"]+\s*/,"").replace(/["]+$/,"").trim()).filter(c=>c.length>2&&c.length<80).slice(0,3);if(!j.length){a.textContent="Could not parse suggestions. Try again.",s.disabled=!1;return}a.textContent="Pick one to rename this schedule:",i.innerHTML=j.map(c=>`<button class="ai-suggestion-pill" data-name="${S(c)}">${h(c)}</button>`).join(""),i.querySelectorAll(".ai-suggestion-pill").forEach(c=>{c.addEventListener("click",()=>{q(e,{name:c.dataset.name,date:t.date}),k(e)})})}catch(p){a.textContent=`Error: ${p.message}`}finally{s.disabled=!1}}function Re(e){return{blocking:"badge-blocking","run-through":"badge-run-through","table work":"badge-table-work",tech:"badge-tech",other:"badge-other"}[e]??"badge-other"}function Fe(e){if(!e)return"";const[t,n,o]=e.split("-");return new Date(+t,+n-1,+o).toLocaleDateString("en-US",{weekday:"long",year:"numeric",month:"long",day:"numeric"})}function h(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function S(e){return String(e??"").replace(/"/g,"&quot;")}C("/",()=>be());C("/production/:id",({id:e})=>ke(e));C("/schedule/:id",({id:e})=>Pe(e));ne(()=>g("/"));ae();sessionStorage.getItem("tour_seen")||setTimeout(V,400);
